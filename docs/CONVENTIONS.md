...
| [Open Liberty](../backends/open-liberty-java/README.md) | MicroProfile JWT / Jakarta Security declarative role checks | Liberty mpJwt validates tokens; name-bound @RequiresRole adapts Keycloak's nested realm_access.roles claim | 🟡 deliberate |
