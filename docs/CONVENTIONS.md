...
| [Open Liberty](../backends/open-liberty-java/README.md) | Bean Validation (@Valid / Hibernate Validator) on inputs | Constrained request records validated through the injected Validator; Stackverse mapper localizes keyed violations | ✅ idiomatic |
