...
| [Micronaut](../backends/micronaut-java/README.md) | Bean Validation: @Valid on @Body with jakarta.validation constraints | Typed @Valid request records use Micronaut Validation; a replacement constraint handler preserves Stackverse field keys, with custom checks retained for normalized/conditional rules | ✅ idiomatic |
