...
function shellHtml(mainHtml: string, options: { includeDialog?: boolean } = {}): string {
...
class StackverseApp extends LitElement {
...
const rootElement = document.querySelector("stackverse-app");
if (!(rootElement instanceof StackverseApp)) throw new Error("stackverse-app not found");
