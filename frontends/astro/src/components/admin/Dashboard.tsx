      ...
      {error() ? (
        ...
        <>
          <div class="sv-stats-grid">
            ...
            >
              ...
              <span class="sv-stat-label">
                {mc(i18n(), "ui.admin.stats.open-reports", stats()!.totals.openReports)}
              </span>
            </a>
          </div>
          ...
          <div class="sv-card">
            ...
            <div class="sv-legend">
              <span><span class="sv-legend-swatch" />{m(i18n(), "ui.admin.stats.bookmarks-created")}</span>
              <span><span class="sv-legend-swatch sv-legend-swatch--secondary" />{m(i18n(), "ui.admin.stats.active-users")}</span>
            </div>
          </div>
        </>
      )}
