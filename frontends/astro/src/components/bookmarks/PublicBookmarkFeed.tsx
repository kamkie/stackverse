...
export function PublicBookmarkFeedContent(props: Props) {
  ...
  return (
    <>
      ...
      {loading() && bookmarks().length === 0 ? (
        ...
        <div class="sv-empty">
          {m(i18n(), q() ? "ui.bookmarks.no-matches" : "ui.bookmarks.empty")}
        </div>
      ) : (
        <>
...
export default function PublicBookmarkFeed() {
  ...
  return (
    ...
    >
      <PublicBookmarkFeedContent toast={island.toast} />
