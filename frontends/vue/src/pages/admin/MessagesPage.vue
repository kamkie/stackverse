...
<template>
    ...
    <div class="sv-toolbar">
        <input v-model="q" class="sv-input" :placeholder="t('ui.messages.search.placeholder')" />
        <select v-model="language" class="sv-select">
            <option value="">
                {{ t("ui.messages.filter.all-languages") }}
            </option>
    ...
    <p v-else-if="messages.length === 0" class="sv-empty">
        {{ t("ui.messages.empty") }}
    </p>
    <template v-else>
            ...
            <table class="sv-table">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td>{{ message.text }}</td>
                        <td>
                            {{ formatDateTime(message.createdAt, resolvedLanguage) }}
                        </td>
