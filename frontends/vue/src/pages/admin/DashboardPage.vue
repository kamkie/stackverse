...
const maxValue = computed(() => {
    const values = stats.value?.daily.flatMap((day) => [day.bookmarksCreated, day.activeUsers]) ?? [
        1,
    ];
    ...
    <template v-else>
        <div class="sv-stats-grid">
            ...
            <div class="sv-stat">
                ...
                <div class="sv-stat-label">
                    {{ t("ui.admin.stats.public-bookmarks") }}
                </div>
            </div>
            <div class="sv-stat">
                <div class="sv-stat-value">
                ...
                <div class="sv-stat-label">
                    {{ t("ui.admin.stats.hidden-bookmarks") }}
                </div>
            </div>
        ...
        <section class="sv-card" :aria-label="t('ui.admin.chart.label')">
            ...
            <div class="sv-legend">
                <span
                    ><i class="sv-legend-swatch" />{{ t("ui.admin.stats.bookmarks-created") }}</span
                >
                <span>
