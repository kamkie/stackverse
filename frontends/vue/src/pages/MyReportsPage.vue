    ...
    <section class="sv-content">
        ...
        <div class="sv-toolbar">
            <select v-model="status" class="sv-select">
                <option value="">
                    {{ t("ui.my-reports.filter.all-statuses") }}
                </option>
    ...
    >
        <form class="sv-form" @submit.prevent="saveReport">
            ...
            >
                ...
                >
                    <option value="spam">
                        {{ t("ui.report.reason.spam") }}
                    </option>
                    <option value="offensive">
                        {{ t("ui.report.reason.offensive") }}
                    </option>
                    <option value="broken-link">
                        {{ t("ui.report.reason.broken-link") }}
                    </option>
                    <option value="other">
                        {{ t("ui.report.reason.other") }}
                    </option>
                </select>
            </Field>
            <Field
