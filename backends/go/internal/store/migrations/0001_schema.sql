...
-- directly ('public', 'open', 'broken-link', ...) — no mapping layer.
-- Tags live in a text[] with a GIN index (a deliberate contrast with
-- spring-kotlin's collection table; see backends/go/README.md).
