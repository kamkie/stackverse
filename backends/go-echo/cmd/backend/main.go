// The Stackverse backend in Go: Echo routing, pgx, and a hand-rolled JWKS
// validator — see backends/go-echo/README.md for the idioms this implementation
// demonstrates.
package main
